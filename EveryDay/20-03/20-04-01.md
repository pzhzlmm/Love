...
- 清空命令 ctrl + w 
- 清屏快捷键 ctrl + l clear 
- ctrl + c  停止进程  ctrl+l  清屏；彻底清屏是：reset  
...
| -l   | 详情,等同于ll长数据串列出，包含文件的属性与权限等等数据；(常用) |
...
![image-20200401154544049](https://sumomoriaty.oss-cn-beijing.aliyuncs.com/image-20200401154544049.png)
